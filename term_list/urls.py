...
urlpatterns = [
    ...
    path(
        "autocomplete-suggestions/<str:attribute>/<search_term>/",
        views.autocomplete_suggestions,
        name="autocomplete_suggestions",
    ),
    path(
        "get-dictionary-content/<str:dictionary>",
        views.get_dictionary_data,
        name="get_dictionary_details",
    ),
    ...
    path(
        "json/begrepp/all/",
        views.all_accepted_terms,
        name="get_all_accepted_terms_as_json",
    ),
    path("json/synonymer/", views.all_synonyms, name="all_synonyms"),
    path(
        "export/attrs/",
        admin_views.ConceptAdmin.export_chosen_attrs_view,
        name="export_chosen_attrs",
    ),
    path(
        "fetch-attributes/", admin_functions.fetch_attributes, name="fetch_attributes"
    ),
]
