    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ordbok.Beställare')),
            ],
        ),
        migrations.CreateModel(
            name='Begrepp',
            fields=[
                ...
                ('beställare_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ordbok.Beställare')),
            ],
        ),
    ]
