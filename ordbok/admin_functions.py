...
from ordbok.models import Dictionary, Begrepp, Bestallare
from ordbok.forms import (ExcelImportForm,
                          ColumnMappingForm)
    ...
    def import_excel_view(self, request):
        ...
        if 'apply' in request.POST:
            ...
            if form.is_valid():
                ...
                model_fields = [f.name for f in Begrepp._meta.get_fields()]
        ...
        if 'confirm_import' in request.POST:
            ...
            try:
                ...
                return redirect("admin:ordbok_begrepp_changelist")
